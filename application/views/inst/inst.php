<div id="content">
    ...
    <table >
        ...
        <tr>
            <td>padotibas_forma</td>
            <td><?php echo $inst_s[0]->padotibas_forma ?></td>
        </tr>
        <tr>
            <td>padotibas_ministrija/td>
        ...
        <tr>
            <td>normativo_aktu_saraksts</td>
            <td><?php echo $inst_s[0]->normativo_aktu_saraksts ?></td>
        </tr>
        <tr>
            <td>publisks_parskats</td>

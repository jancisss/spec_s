        ...
        <div class="navbar navbar-static-top">
            <div class="navbar-inner">            
                ...
                <ul class="nav"><? if (!isset($active_page)) $active_page = ''; ?>
                    ...
                    <li class="<?php
                    if ($active_page == 'budget')
                        echo 'active';
                        ?>"><a href="<?php echo base_url('/budget'); ?>">Budžets</a></li>
                    <li class="<?php
                    if ($active_page == 'import')
                        echo 'active';
                    ?>"><a href="<?php echo base_url('/import'); ?>">Datu imports</a></li>
                    <li class="<?php
                    if ($active_page == 'budget2014')
                        echo 'active';
                    ?>"><a href="<?php echo base_url('/budget2014'); ?>">Budžets 2014</a></li>
                </ul>
